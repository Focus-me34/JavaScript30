...
// ! While looping, if the elements in between the start and the end of the loop are checked, we skip them directly. No time wasted
// ! We reinitialise the click count to 0 zhenever we selected the start and end inputs.
